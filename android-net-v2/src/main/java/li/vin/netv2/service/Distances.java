...
public interface Distances {
  ...
  @GET
  Observable<Odometer.Wrapper> odometerReportForUrl( //
      @NonNull @Url String url //
  );

  @GET
  Observable<Odometer.TimeSeries> odometerReportsForUrl( //
      @NonNull @Url String url //
  );
  ...
  @GET
  Observable<OdometerTrigger.TimeSeries> odometerTriggersForUrl( //
      @NonNull @Url String url //
  );

  @GET
  Observable<OdometerTrigger.Wrapper> odometerTriggerForUrl( //
      @NonNull @Url String url //
  );
}
